...
class RandomTextGenerator(BaseTextGenerator):
    ...
    def generate_example(self) -> Dict[str, Any]:
        ...
        """
        example = {"id": random.randint(1, 1000000), "text": self._generate_text()}
...
class TemplateTextGenerator(BaseTextGenerator):
        ...
        for template in templates:
            for var_name in self._extract_variables(template):
                if var_name not in variables:
                    raise ValueError(
                        f"Variable '{var_name}' in template not found in variables dict"
                    )
    ...
    def generate_example(self) -> Dict[str, Any]:
        ...
        example = {"id": random.randint(1, 1000000), "text": text}

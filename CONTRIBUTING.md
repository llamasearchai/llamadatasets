# Contributing to LlamaDatasets

Thank you for your interest in contributing to LlamaDatasets! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaDatasets:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamadatasets.git
   cd llamadatasets
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamadatasets.git
   ```
...
By contributing to LlamaDatasets, you agree that your contributions will be licensed under the project's MIT License.
